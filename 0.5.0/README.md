...
- **封面显示模式**：视频库封面支持「横屏比例」（默认 16:9 黑底居中）与「正常比例」切换。
- **关键帧概览**：扫描/导入视频时自动生成关键帧，按视频时长生成 3/6/9/12 张（960px JPEG 压缩，占用极小）；视频库与元数据页右键视频即可查看，点击小图放大。
...
历史版本源码按版本归档于 `0.2.0/`、`0.3.0/`、`0.4.0/`、`0.5.0/` 目录；各版本安装包见 [Releases](https://github.com/iop666/VideoManager/releases)。
