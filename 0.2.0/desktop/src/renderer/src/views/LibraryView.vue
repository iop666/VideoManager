...
onMounted(() => {
  void library.loadPageSize().then(async () => {
    ...
    <n-spin :show="library.loading">
      <template v-if="library.items.length">
        ...
        <div v-if="viewMode === 'grid'" class="grid">
          <div v-for="v in library.items" :key="v.id" class="card">
            <div class="thumb-wrap" @click="playWithPlayer(v)">
            ...
            <div class="card-meta" @click="library.openDetail(v.id)">
              ...
              <span v-if="fullMeta && v.author">· {{ v.author }}</span>
            </div>
            <div class="card-tags" @click="library.openDetail(v.id)">
              <n-tag
                v-for="t in (fullMeta ? v.tags : v.tags.slice(0, 3))"
                :key="t"
                size="tiny"
                :bordered="false"
        ...
        <div v-else class="list">
          <div v-for="v in library.items" :key="v.id" class="list-item">
